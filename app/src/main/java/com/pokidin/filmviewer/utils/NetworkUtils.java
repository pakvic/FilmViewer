package com.pokidin.filmviewer.utils;
...
public class NetworkUtils {
    ...
    private static final String BASE_URL_FAVORITE = "https://api.themoviedb.org/3/movie/%s";
    ...
    private static final String API_KEY = "a146385b61740238b55640dd444f0efa";
    private static final String SORT_BY_POPULARITY = "popularity.desc";
    private static final String SORT_BY_TOP_RATED = "vote_average.desc";
    private static final String MIN_COUNT_VALUE = "100";
    ...
    public static URL buildURLToFavorite(int id, String lang){
        Uri uri = Uri.parse(String.format(BASE_URL_FAVORITE, id)).buildUpon()
                .appendQueryParameter(PARAMS_API_KEY, API_KEY)
                .appendQueryParameter(PARAMS_LANGUAGE, lang).build();
    ...
    public static URL buildURL(int sortBy, int page, String lang) {
        ...
        Uri uri = Uri.parse(BASE_URL).buildUpon()
                ...
                .appendQueryParameter(PARAMS_MIN_VOTE_COUNT, vote)
    ...
    public static JSONObject getJSONForFavorite(int id, String lang) {
        JSONObject result = null;
        URL url = buildURLToFavorite(id, lang);
        try {
